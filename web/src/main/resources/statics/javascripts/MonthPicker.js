...
(function ($, window, document) {
    ...
    var _markup =
        '<div class="ui-datepicker-header ui-widget-header ui-helper-clearfix ui-corner-all">' +
            '<a class="ui-datepicker-prev ui-corner-all previous-year" data-handler="prev" data-event="click"></a>' +
            '<a class="ui-datepicker-next ui-corner-all next-year" data-handler="next" data-event="click"></a>' +
            '<div class="ui-datepicker-title">' +
                '<span class="ui-datepicker-year year"></span><span class="year-title"/>' +
            '</div>' +
    ...
    $.widget("KidSysco.MonthPicker", {
        ...
        _create: function () {
            ...
            var _menu = this._monthPickerMenu = $('<div id="MonthPicker_' + _el.attr('id') + '" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all month-picker"></div>');
            ...
            this._prevButton = $('a.previous-year', _menu).button({ text: false });
            this._nextButton = $('a.next-year', _menu).button({ text: false });
        ...
        _chooseMonth: function (month) {
            ...
            this.options.OnAfterChooseMonth.call(this.element[0], date);
        },
